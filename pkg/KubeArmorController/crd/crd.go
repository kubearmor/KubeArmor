...
//go:embed KubeArmorNetworkPolicy.yaml
var nspCrdBytes []byte
...
func GetNspCRD() apiextensionsv1.CustomResourceDefinition {
	nsp := apiextensionsv1.CustomResourceDefinition{}
	err := yaml.Unmarshal(nspCrdBytes, &nsp)
	if err != nil {
		log.Fatal("Error unmarshalling pregenerated CRD")
	}
	return nsp
