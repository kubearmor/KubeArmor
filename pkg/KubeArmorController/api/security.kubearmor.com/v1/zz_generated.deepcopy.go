...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrafficType) DeepCopyInto(out *TrafficType) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficType.
func (in *TrafficType) DeepCopy() *TrafficType {
	if in == nil {
		return nil
	}
	out := new(TrafficType)
