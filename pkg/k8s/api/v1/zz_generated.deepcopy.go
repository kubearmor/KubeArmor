...
func (in *ResourceType) DeepCopyInto(out *ResourceType) {
	*out = *in
	if in.MatchResources != nil {
		...
		*out = make([]ResourceValueType, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceValueType) DeepCopyInto(out *ResourceValueType) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceValueType.
func (in *ResourceValueType) DeepCopy() *ResourceValueType {
	if in == nil {
		return nil
	}
	out := new(ResourceValueType)
	in.DeepCopyInto(out)
	return out
}
