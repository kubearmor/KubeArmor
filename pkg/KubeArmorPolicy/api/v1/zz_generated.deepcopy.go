...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatchMountedVolumeType) DeepCopyInto(out *MatchMountedVolumeType) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatchMountedVolumeType.
func (in *MatchMountedVolumeType) DeepCopy() *MatchMountedVolumeType {
	if in == nil {
		return nil
	}
	out := new(MatchMountedVolumeType)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SELinuxType) DeepCopyInto(out *SELinuxType) {
	*out = *in
	if in.MatchMountedVolumes != nil {
		in, out := &in.MatchMountedVolumes, &out.MatchMountedVolumes
		*out = make([]MatchMountedVolumeType, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
