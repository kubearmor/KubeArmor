...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG KarmorProviderEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG KarmorProviderKeywords[2] = {0x0, 0x0};
EXTERN_C __declspec(selectany) const unsigned char KarmorProviderLevels[2] = {3, 4};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT KarmorProvider_Context = {0, (ULONG_PTR)KarmorProvider_Traits, 0, 0, 0, 0, 0, 0, 2, KarmorProviderEnableBits, KarmorProviderKeywords, KarmorProviderLevels};

//
// Provider REGHANDLE
//
#define KarmorProviderHandle (KarmorProvider_Context.RegistrationHandle)
...
//
#define KarmorProvider_EventWriteActivity 1
...
//
#ifndef EventRegisterKarmorProvider
#define EventRegisterKarmorProvider() McGenEventRegister(&KarmorProvider, McGenControlCallbackV2, &KarmorProvider_Context, &KarmorProviderHandle)
#endif
...
//
#ifndef EventRegisterByGuidKarmorProvider
#define EventRegisterByGuidKarmorProvider(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &KarmorProvider_Context, &KarmorProviderHandle)
#endif
...
//
#ifndef EventUnregisterKarmorProvider
#define EventUnregisterKarmorProvider() McGenEventUnregister(&KarmorProviderHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_KarmorProvider));
// - Caller registers the provider, e.g. EventRegisterKarmorProvider_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterKarmorProvider_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_KarmorProvider {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use KarmorProviderHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_KarmorProvider;

#define EventRegisterKarmorProvider_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_KarmorProvider_, MCGEN_EVENTREGISTER)(&KarmorProvider, pContext)
#define EventRegisterByGuidKarmorProvider_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_KarmorProvider_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterKarmorProvider_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define KarmorProviderHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_KarmorProvider_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_KarmorProvider* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)KarmorProvider_Traits;
    pContext->Context.EnableBitsCount = 2;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = KarmorProviderKeywords;
    pContext->Context.EnableLevel = KarmorProviderLevels;
...
FORCEINLINE
_Ret_ McGenContext_KarmorProvider*
_mcgen_CheckContextType_KarmorProvider(_In_ McGenContext_KarmorProvider* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "ProcessBlocked"
//
#define EventEnabledProcessBlocked() _mcgen_EVENT_BIT_SET(KarmorProviderEnableBits, 0)
#define EventEnabledProcessBlocked_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_KarmorProvider(pContext)->EnableBits, 0)

//
// Event write macros for event "ProcessBlocked"
//
#define EventWriteProcessBlocked(Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        MCGEN_EVENT_ENABLED(ProcessBlocked) \
        ? _mcgen_TEMPLATE_FOR_ProcessBlocked(&KarmorProvider_Context, &ProcessBlocked, Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) : 0
#define EventWriteProcessBlocked_AssumeEnabled(ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        _mcgen_TEMPLATE_FOR_ProcessBlocked(&KarmorProvider_Context, &ProcessBlocked, NULL, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName)
#define EventWriteProcessBlocked_ForContext(pContext, Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ProcessBlocked) \
        ? _mcgen_TEMPLATE_FOR_ProcessBlocked(&(pContext)->Context, &ProcessBlocked, Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) : 0
#define EventWriteProcessBlocked_ForContextAssumeEnabled(pContext, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        _mcgen_TEMPLATE_FOR_ProcessBlocked(&_mcgen_CheckContextType_KarmorProvider(pContext)->Context, &ProcessBlocked, NULL, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ProcessBlocked _mcgen_PASTE2(McTemplateK0qqzzzz_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "ProcessAudited"
//
#define EventEnabledProcessAudited() _mcgen_EVENT_BIT_SET(KarmorProviderEnableBits, 1)
#define EventEnabledProcessAudited_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_KarmorProvider(pContext)->EnableBits, 1)

//
// Event write macros for event "ProcessAudited"
//
#define EventWriteProcessAudited(Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        MCGEN_EVENT_ENABLED(ProcessAudited) \
        ? _mcgen_TEMPLATE_FOR_ProcessAudited(&KarmorProvider_Context, &ProcessAudited, Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) : 0
#define EventWriteProcessAudited_AssumeEnabled(ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        _mcgen_TEMPLATE_FOR_ProcessAudited(&KarmorProvider_Context, &ProcessAudited, NULL, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName)
#define EventWriteProcessAudited_ForContext(pContext, Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ProcessAudited) \
        ? _mcgen_TEMPLATE_FOR_ProcessAudited(&(pContext)->Context, &ProcessAudited, Activity, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) : 0
#define EventWriteProcessAudited_ForContextAssumeEnabled(pContext, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName) \
        _mcgen_TEMPLATE_FOR_ProcessAudited(&_mcgen_CheckContextType_KarmorProvider(pContext)->Context, &ProcessAudited, NULL, ProcessId, ParentProcessId, ImagePath, CommandLine, UserSid, RuleName)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ProcessAudited _mcgen_PASTE2(McTemplateK0qqzzzz_, MCGEN_EVENTWRITETRANSFER)
...
//
// Function for template "ProcessEventTemplate" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateK0qqzzzz_def
#define McTemplateK0qqzzzz_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateK0qqzzzz_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
...
{
#define McTemplateK0qqzzzz_ARGCOUNT 6

    EVENT_DATA_DESCRIPTOR EventData[McTemplateK0qqzzzz_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, Activity, McTemplateK0qqzzzz_ARGCOUNT + 1, EventData);
}
#endif // McTemplateK0qqzzzz_def
