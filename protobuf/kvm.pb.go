...
var file_kvm_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6b, 0x76, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x6b, 0x76, 0x6d,
	0x41, 0x67, 0x65, 0x6e, 0x74, 0x22, 0x2b, 0x0a, 0x0d, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x64,
	...
	0x61, 0x74, 0x75, 0x73, 0x22, 0x4c, 0x0a, 0x0a, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x44, 0x61,
	0x74, 0x61, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4e, 0x61, 0x6d, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4e, 0x61,
	0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x44, 0x61, 0x74, 0x61,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x44, 0x61,
	...
	0x69, 0x74, 0x79, 0x12, 0x17, 0x2e, 0x6b, 0x76, 0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x1a, 0x10, 0x2e, 0x6b,
	0x76, 0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x38,
	0x0a, 0x0a, 0x73, 0x65, 0x6e, 0x64, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x10, 0x2e, 0x6b,
	0x76, 0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x14,
	0x2e, 0x6b, 0x76, 0x6d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	0x44, 0x61, 0x74, 0x61, 0x28, 0x01, 0x30, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68,
...
var file_kvm_proto_goTypes = []interface{}{
	(*AgentIdentity)(nil), // 0: kvmAgent.agentIdentity
	(*Status)(nil),        // 1: kvmAgent.status
	(*PolicyData)(nil),    // 2: kvmAgent.policyData
}
var file_kvm_proto_depIdxs = []int32{
	0, // 0: kvmAgent.KVM.registerAgentIdentity:input_type -> kvmAgent.agentIdentity
	1, // 1: kvmAgent.KVM.sendPolicy:input_type -> kvmAgent.status
	1, // 2: kvmAgent.KVM.registerAgentIdentity:output_type -> kvmAgent.status
	2, // 3: kvmAgent.KVM.sendPolicy:output_type -> kvmAgent.policyData
...
func (c *kVMClient) RegisterAgentIdentity(ctx context.Context, in *AgentIdentity, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/kvmAgent.KVM/registerAgentIdentity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *kVMClient) SendPolicy(ctx context.Context, opts ...grpc.CallOption) (KVM_SendPolicyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_KVM_serviceDesc.Streams[0], "/kvmAgent.KVM/sendPolicy", opts...)
	if err != nil {
		return nil, err
	}
...
func _KVM_RegisterAgentIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kvmAgent.KVM/RegisterAgentIdentity",
	}
