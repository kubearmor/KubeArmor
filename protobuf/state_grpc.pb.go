...
func (c *stateAgentClient) WatchState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (StateAgent_WatchStateClient, error) {
...
func (c *stateAgentClient) GetState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (StateAgent_GetStateClient, error) {
...
func (UnimplementedStateAgentServer) WatchState(*emptypb.Empty, StateAgent_WatchStateServer) error {
	return status.Errorf(codes.Unimplemented, "method WatchState not implemented")
}
func (UnimplementedStateAgentServer) GetState(*emptypb.Empty, StateAgent_GetStateServer) error {
