...
type StateAgentClient interface {
	...
	WatchState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StateEvent], error)
	// get all state events in one go
	GetState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StateEvents], error)
}
...
func (c *stateAgentClient) WatchState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StateEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StateAgent_ServiceDesc.Streams[0], StateAgent_WatchState_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, StateEvent]{ClientStream: stream}
...
func (c *stateAgentClient) GetState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StateEvents], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StateAgent_ServiceDesc.Streams[1], StateAgent_GetState_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, StateEvents]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type StateAgentServer interface {
	// stream which continuously pushes state events
	WatchState(*emptypb.Empty, grpc.ServerStreamingServer[StateEvent]) error
	// get all state events in one go
	GetState(*emptypb.Empty, grpc.ServerStreamingServer[StateEvents]) error
}
...
func (UnimplementedStateAgentServer) WatchState(*emptypb.Empty, grpc.ServerStreamingServer[StateEvent]) error {
	return status.Error(codes.Unimplemented, "method WatchState not implemented")
}
func (UnimplementedStateAgentServer) GetState(*emptypb.Empty, grpc.ServerStreamingServer[StateEvents]) error {
	return status.Error(codes.Unimplemented, "method GetState not implemented")
}
...
func RegisterStateAgentServer(s grpc.ServiceRegistrar, srv StateAgentServer) {
	// If the following call panics, it indicates UnimplementedStateAgentServer was
...
func _StateAgent_WatchState_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StateAgentServer).WatchState(m, &grpc.GenericServerStream[emptypb.Empty, StateEvent]{ServerStream: stream})
}
...
func _StateAgent_GetState_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StateAgentServer).GetState(m, &grpc.GenericServerStream[emptypb.Empty, StateEvents]{ServerStream: stream})
}
