...
var file_policy_proto_depIdxs = []int32{
	...
	1,  // 8: policy.ReversePolicyService.containerPolicy:input_type -> policy.response
	1,  // 9: policy.ReversePolicyService.hostPolicy:input_type -> policy.response
	...
	2,  // 13: policy.ReversePolicyService.containerPolicy:output_type -> policy.policy
	2,  // 14: policy.ReversePolicyService.hostPolicy:output_type -> policy.policy
