...
func (x *Alert) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
const file_kubearmor_proto_rawDesc = "" +
	...
	"\x0eExecutableName\x18\x02 \x01(\tR\x0eExecutableName\"\x8c\v\n" +
	"\x05Alert\x12\x1c\n" +
	"\tTimestamp\x18\x01 \x01(\x03R\tTimestamp\x12 \n" +
	"\vUpdatedTime\x18\x02 \x01(\tR\vUpdatedTime\x12 \n" +
	"\vClusterName\x18\x03 \x01(\tR\vClusterName\x12\x1a\n" +
	...
	"\bHashAlgo\x18* \x01(\tR\bHashAlgo\x12\x1a\n" +
	"\bUserName\x18, \x01(\tR\bUserName\x1a<\n" +
