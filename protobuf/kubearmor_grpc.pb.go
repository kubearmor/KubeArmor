...
const (
	PushLogService_HealthCheck_FullMethodName  = "/feeder.PushLogService/HealthCheck"
	PushLogService_PushMessages_FullMethodName = "/feeder.PushLogService/PushMessages"
	PushLogService_PushAlerts_FullMethodName   = "/feeder.PushLogService/PushAlerts"
	PushLogService_PushLogs_FullMethodName     = "/feeder.PushLogService/PushLogs"
)
...
func (c *pushLogServiceClient) HealthCheck(ctx context.Context, in *NonceMessage, opts ...grpc.CallOption) (*ReplyMessage, error) {
	out := new(ReplyMessage)
	err := c.cc.Invoke(ctx, PushLogService_HealthCheck_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pushLogServiceClient) PushMessages(ctx context.Context, opts ...grpc.CallOption) (PushLogService_PushMessagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &PushLogService_ServiceDesc.Streams[0], PushLogService_PushMessages_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pushLogServiceClient) PushAlerts(ctx context.Context, opts ...grpc.CallOption) (PushLogService_PushAlertsClient, error) {
	stream, err := c.cc.NewStream(ctx, &PushLogService_ServiceDesc.Streams[1], PushLogService_PushAlerts_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pushLogServiceClient) PushLogs(ctx context.Context, opts ...grpc.CallOption) (PushLogService_PushLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &PushLogService_ServiceDesc.Streams[2], PushLogService_PushLogs_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _PushLogService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PushLogService_HealthCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
