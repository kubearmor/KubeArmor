...
func (UnimplementedProbeServiceServer) GetProbeData(context.Context, *emptypb.Empty) (*ProbeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProbeData not implemented")
}
...
const (
	...
	PolicyService_NetworkPolicy_FullMethodName   = "/policy.PolicyService/networkPolicy"
)
...
type PolicyServiceClient interface {
	...
	NetworkPolicy(ctx context.Context, in *Policy, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *policyServiceClient) ContainerPolicy(ctx context.Context, in *Policy, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, PolicyService_ContainerPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) HostPolicy(ctx context.Context, in *Policy, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, PolicyService_HostPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) NetworkPolicy(ctx context.Context, in *Policy, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, PolicyService_NetworkPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PolicyServiceServer interface {
	...
	NetworkPolicy(context.Context, *Policy) (*Response, error)
}
...
func (UnimplementedPolicyServiceServer) ContainerPolicy(context.Context, *Policy) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method ContainerPolicy not implemented")
}
func (UnimplementedPolicyServiceServer) HostPolicy(context.Context, *Policy) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method HostPolicy not implemented")
}
func (UnimplementedPolicyServiceServer) NetworkPolicy(context.Context, *Policy) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method NetworkPolicy not implemented")
}
...
func _PolicyService_NetworkPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Policy)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyServiceServer).NetworkPolicy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyService_NetworkPolicy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).NetworkPolicy(ctx, req.(*Policy))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PolicyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "networkPolicy",
			Handler:    _PolicyService_NetworkPolicy_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "policy.proto",
