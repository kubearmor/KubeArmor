...
{
  "🆕 New Features": [
    "Added safer cleanup behavior that prevents accidental deletion of important directories during teardown."
  ],
  "🎁 Misc": [
    "Made the SELinux profile directory configurable at startup so it is consistently loaded from configuration."
  ]
}
