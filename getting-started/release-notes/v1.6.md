...
{
  "🎁 Misc": [
    "Improved the reliability and speed of the concurrency test suite to reduce flakiness during automated runs."
  ],
  "🐜 Bug Fixes": [
    "Improved the system’s thread-safety when multiple operations access endpoint and host policy data at the same time."
  ]
}
