...
- Added no new user-facing features; this patch focuses on reliability fixes.

### 🐛 Bug Fixes

- Fixed CRI socket URL formatting and ensured the corrected socket argument is applied so the runtime connection works reliably in more setups.

### 🎁 Misc

- Made no additional user-facing changes beyond the bug fix above.
