...
Released on **2026-02-22** (**v1.6.8**).

### 🎁 Misc

- Improved policy enforcement reliability by expanding container and host policy test coverage and adding unit tests for `PolicyServer` policy-handling behavior.
