...
- Fixed resource leaks during Feeder initialization: closed gRPC listener and log file when NewFeeder() failed, preventing port and file descriptor conflicts on consecutive runs. (Fixes #2158)
...
- Enabled coverage metrics in CI by building with coverage flags and collecting/uploading artifacts in CI-Network-Tests and CI-Test-UBI-Image workflows.
