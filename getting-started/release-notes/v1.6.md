...
- Fixed KubeArmor Helm chart templating so installations render correctly and workloads start with the intended settings.

- Improved TCP accept event processing to reduce overhead and match TCP connect tracing behavior.
