...
* Added a configurable `--socket-file` option (plumbed from Helm to snitch) to explicitly select the container runtime socket and avoid runtime auto-detection issues.
