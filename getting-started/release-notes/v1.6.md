...
* Improved host-only developer runs by adding timestamps to USB logs, disabling Kubernetes mode via `k8s=false`, and bumping dependencies including Go to 1.24.13 and github.com/cilium/cilium to v1.18.4.
