...
{
  "🎁 Misc": [
    "Improved reliability when multiple parts of the system update or read alerts at the same time. This change adds an RWMutex around the shared AlertMap and uses it during alert throttling operations to prevent concurrent access issues."
  ]
}
