...
```json
{
  ...
  "🎁 Misc": [
    ...
    "Added default CPU and memory requests/limits for relay, controller, DaemonSet, and snitch components.",
    ...
    "Updated CI and tests to use the correct Helm image-tag key for `kubearmor-operator` and to pass the LSM order flag during test runs."
  ],
  "🐜 Bug Fixes": [
