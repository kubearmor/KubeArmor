...
{
  "🆕 New Features": [
    "The system can now skip starting the enforcer automatically when no Linux Security Module (LSM) is configured, which avoids unnecessary setup and potential startup problems in environments that don’t use an LSM."
  ]
}
