...
- Added consolidated operator configuration via **OperatorOptions**, and pass the selected LSM order to managed KubeArmor components via command-line arguments.
