...
- Added EventData (key-value) to Alert and Log telemetry for structured access; feeder populated it for gRPC and JSON outputs while preserving the original Data string for backward compatibility. Fixes #2173.
