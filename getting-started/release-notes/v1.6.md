...
- Fixed TCP connection monitoring to show the correct protocol name in events (Fixes [#2353](https://github.com/kubearmor/KubeArmor/issues/2353); [3382dc8](https://github.com/kubearmor/KubeArmor/commit/3382dc81cebd87f6564cf451cb56a7f5347dd1d0)).
