...
{
  "🆕 New Features": [
    "You can now match and enforce policies based on the arguments a process was started with.",
    "You can now disable LSM-based enforcement explicitly when you don’t want any runtime enforcer to run."
  ],
  "🎁 Misc": [
    "The Go codebase has been modernized without changing intended behavior.",
    "Continuous integration tests are now more stable and representative of the expected workloads.",
    "Build, release, and security-scanning dependencies have been updated to current versions.",
    "Documentation and examples have been updated to better reflect supported environments and usage.",
    "Configuration handling has been made more flexible for runtime operation and logging.",
    "Command-line and operator configuration has been simplified to reduce duplication and improve consistency.",
    "Repository metadata has been refreshed for the current year."
  ],
  "🐛 Bug Fixes": [
    "Cleanup operations are now safer and less likely to delete unintended paths.",
    "Kernel event handling is now more robust when recording the protocol name for TCP connect events.",
    "Policy and eBPF key sizing is now consistent with documented limits to avoid truncation and mismatches."
  ]
}
