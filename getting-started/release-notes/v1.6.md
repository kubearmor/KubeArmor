...
- Fixed AppArmor policy enforcement when KubeArmor was deployed in namespaces other than `kubearmor` by scanning all namespaces for pods labeled `kubearmor-app=kubearmor`.
