...
- Improved runtime detection for socket-based connections by deriving the runtime from the detected socket path in `DetectRuntimeViaMap` using `determineRuntimeFromSocket`.
