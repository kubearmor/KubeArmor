...
## Latest Release Updates (2025-12-03)

## Improvements

- Updated the KubeArmor and KubeArmorOperator Helm charts (and their dependencies) to version v1.6.5 to align deployment manifests with the latest application release and chart fixes.
