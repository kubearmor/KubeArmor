...
- Enhanced configuration clarity and reduced noisy security warnings during builds by renaming the Kubernetes secret field to `SecretName` and adding targeted gosec suppression annotations.
