...
- Updated GoReleaser signing to use cosign v3 with `--bundle`, producing `${artifact}.sigstore.json` bundles; no user-facing impact. See [GoReleaser cosign v3](https://goreleaser.com/blog/cosign-v3/) and [commit 600e87a](https://github.com/kubearmor/KubeArmor/commit/600e87a28e2939e71ac9a2afb5bc208a8ca4b2c9).
