...
- Updated GoReleaser signing to use cosign v3 with `--bundle`, producing `${artifact}.sigstore.json` bundles; no user-facing impact. See [GoReleaser cosign v3](https://goreleaser.com/blog/cosign-v3/).
