...
{
  "🐛 Bug Fixes": [
    "We fixed an issue where the container runtime interface (CRI) socket address could be formatted incorrectly, which could prevent the system from connecting to the runtime."
  ]
}
