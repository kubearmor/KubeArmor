...
{
  "🎁 Misc": [
    "Improved configuration clarity and reduced noisy security warnings during builds. Specifically, the Kubernetes secret field was renamed to `SecretName`, and selected file/path handling plus HTTP call sites were annotated with gosec suppression comments."
  ]
}
