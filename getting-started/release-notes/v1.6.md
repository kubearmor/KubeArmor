...
- Added an option to drop the Kubernetes **Resource** field from process visibility logs (PR [#2044](https://github.com/kubearmor/KubeArmor/pull/2044)).
...
- Updated the KubeArmor Operator chart and configuration documentation to support dropping the **Resource** field at deploy time via `dropResourceFromProcessLogs` (PR [#2044](https://github.com/kubearmor/KubeArmor/pull/2044)).
