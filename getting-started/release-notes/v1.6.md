...
- Added support for running host-only workflows without starting Kubernetes (`k8s=false`) and for stamping USB log entries with timestamps for easier troubleshooting.

### 🐛 Bug Fixes

_No user-facing bug fixes are documented for this patch release._

### 🎁 Misc

- Updated core dependencies to keep the toolchain and networking components current, including Go 1.24.13 and `github.com/cilium/cilium` v1.18.4.
