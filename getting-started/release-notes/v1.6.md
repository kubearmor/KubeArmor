...
- Added command-line argument matching for process execution rules so policies can allow or deny a program more precisely than by path alone.

### 🐜 Bug Fixes

- Fixed ownership and argument enforcement plus cleanup behavior for argument-matching policies to improve reliability.

### 🎁 Misc

- Improved memory usage and aligned schema validation limits with runtime buffer constraints for internal key fields.
