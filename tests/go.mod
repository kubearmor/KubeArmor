...
require (
	...
	github.com/kubearmor/KubeArmor/KubeArmor v0.0.0-20250526061550-bac6deab5fa8 // indirect
	...
	sigs.k8s.io/structured-merge-diff/v4 v4.7.0 // indirect; indirect	sigs.k8s.io/yaml v1.4.0 // indirect
)
