...
var _ = Describe("Posture", func() {
    ...
    Describe("Policy Apply", func() {
        It("can whitelist use of certain network protocols used by a package, such as tcp", func() {
            ...
            // Use AssertCommand to replace direct execution and checking
            AssertCommand(
