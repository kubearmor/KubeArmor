...
* Process Execution Restriction
  * Block a specific executable \([ksp-group-1-proc-path-block.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-group-1-proc-path-block.yaml)\)
  ...
  * Block all executables in a specific directory \([ksp-ubuntu-1-proc-dir-block.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-1-proc-dir-block.yaml)\)
  ...
  * Block all executables in a specific directory and its subdirectories \([ksp-ubuntu-2-proc-dir-recursive-block.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-2-proc-dir-recursive-block.yaml)\)
  ...
  * Allow specific executables only \([ksp-ubuntu-3-proc-dir-allow.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-3-proc-dir-allow.yaml)\)
  ...
  * Allow a specific executable to be launched by its owner only \([ksp-ubuntu-3-proc-path-owner-only.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-3-proc-path-owner-only.yaml)\)
...
* File Access Restriction
  * Allow accessing specific files only \([ksp-ubuntu-4-file-path-readonly-allow.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-4-file-path-readonly-allow.yaml)\)
  ...
  * Block all file accesses in a specific directory and its subdirectories \([ksp-ubuntu-5-file-dir-recursive-block.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-5-file-dir-recursive-block.yaml)\)
...
* Network Operation Restriction
  * Block ICMP packets \([ksp-ubuntu-5-net-icmp-block](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-5-net-icmp-block.yaml)\)
...
* Capabilities Restriction
  * Block Raw Sockets \(i.e., non-TCP/UDP packets\) \([ksp-ubuntu-1-cap-net-raw-block.yaml](https://github.com/accuknox/KubeArmor/tree/2da01a6c9b8bcee32577671aef0dba853b2deb7b/examples/multiubuntu/security-policies/ksp-ubuntu-1-cap-net-raw-block.yaml)\)
