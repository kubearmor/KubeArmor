...
#!/bin/sh
set -e
# Code generated by godownloader on 2022-04-29T08:14:49Z. DO NOT EDIT.
#
...
$this: download binaries for kubearmor/kubearmor

Usage: $this [-b bindir] [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
  [tag] is a tag from
  https://github.com/kubearmor/kubearmor/releases
...
execute() {
  ...
  http_download "/tmp/${NAME}" "$TARBALL_URL"
}
