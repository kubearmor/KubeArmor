...
func readCmdLineParams() {
	...
	visStr := flag.String(ConfigVisibility, "\"default: off\" Container visbility", "enable visibility for specified namespace(s) and specified actions process,file,network,capabilities. usage: \"sudo ./kubearmor -visibility -n mynamespace\" ")
