...
func (c *CRIOHandler) HandleCreateContainer(container types.Container) {
    c.daemon.handlePodmanContainerCreate(container)
}
func (c *CRIOHandler) HandleDeleteContainer(containerID string) {
    c.daemon.handlePodmanContainerDelete(containerID)
}
...
func (dm *KubeArmorDaemon) handlePodmanConn(conn net.Conn, ready *atomic.Bool) {
...
func (dm *KubeArmorDaemon) handlePodmanContainerCreate(container types.Container) {
...
func (dm *KubeArmorDaemon) handlePodmanContainerDelete(containerID string) {
	dm.ContainersLock.Lock()
